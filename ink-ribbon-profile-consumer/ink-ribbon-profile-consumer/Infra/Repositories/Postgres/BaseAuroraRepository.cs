using Dapper;
using ink_ribbon_profile_consumer.Domain.Interfaces.Repositories;
using ink_ribbon_profile_consumer.Infra.Context;

namespace ink_ribbon_profile_consumer.Infra.Repositories.Postgres
{
